...
| 2 | ElevenLabs 생성물의 이용 권리와 환산율 — **확인 완료(2026-08-10):** 상업 라이선스는 Starter($6/월)부터, API는 구독 크레딧 공용(권장 Creator $11/월), 환산율 초당 $0.004~0.008. 갤러리 재배포 문구 세부만 M9 약관 재대조에 묶음 | REQUIREMENTS 7.2·9절 |
